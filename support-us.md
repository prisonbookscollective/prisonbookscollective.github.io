...
<div class="support-method" style="--index: 1">
	...
	<div class="content">
		...
		<p></p>
		<p>If you would like to order high-demand books, we keep active wishlists at three local, independent bookstores: <a href="{{ site.flyleaf_wishlist }}">Flyleaf Books</a>, <a href="{{ site.quailRidge_wishlist }}">Quail Ridge Books</a>, and <a href="{{ site.goldenFig_wishlist }}">Golden Fig Books</a>. When books are purchased from our registries, we pick them up and bring them to the workspace.</p>
		...
		<a href="{{ site.goldenFig_wishlist }}" class="btn-secondary external-link">Golden Fig registry</a>
